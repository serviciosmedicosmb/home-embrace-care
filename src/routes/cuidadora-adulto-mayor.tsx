          ...
          <div className="relative mx-auto max-w-7xl px-5 lg:px-8 grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="animate-fade-up">
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <a href={waLink("Hola, quiero solicitar información sobre cuidadoras de adulto mayor.")} target="_blank" rel="noopener noreferrer" className="btn-whatsapp">
                  <MessageCircle className="h-5 w-5" /> Solicitar Información
                </a>
                <a href={waLink("Hola, quiero contactar por WhatsApp sobre cuidadoras de adulto mayor.")} target="_blank" rel="noopener noreferrer" className="btn-outline">
              ...
              <ul className="mt-10 grid sm:grid-cols-3 gap-4 text-sm">
                {[
                  { Icon: Clock, label: "Turnos 12/24h" },
                  { Icon: ShieldCheck, label: "Personal capacitado" },
            ...
            <div className="relative animate-fade">
              ...
              <div className="relative rounded-[2rem] overflow-hidden shadow-card border border-white">
                <img src={heroImg} alt="Cuidadora acompañando a adulto mayor en su hogar" width={1408} height={1146} className="w-full h-auto object-cover" />
              </div>
            </div>
          </div>
        </section>
